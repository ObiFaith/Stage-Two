...
const CartList = ({id, img, name, price, colors, isNew, available, qty}) => {
  const { dispatch } = CartState()

  return (
    <div>
      <div className="lg:grid flex max-sm:flex-col gap-5 lg:grid-cols-5 md:gap-10 lg:gap-20">
        <div className="relative lg:border border-[#BAE2E1] rounded-[32px] lg:p-4">
          <img src={img} alt='prod img' className='max-sm:w-full object-cover' />
