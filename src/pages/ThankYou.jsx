    ...
    <div className="container pb-36">
      <div className="lg:grid grid-cols-2">
        <div className="rounded-[2rem] shadow-md p-8 max-lg:px-2.5 max-lg:pt-2.5">
          <h2 className="lg:text-2xl text-center text-xl text-green-400">Thank you Branny Gravlin!</h2>
          <p className="lg:text-lg text-center text-base py-9 text-green-800">Order code: #243662H</p>
          ...
          <CartSummary shippingFee = '$50.00' className="justify-center py-9" />
            ...
            <div className="flex max-sm:flex-col sm:items-center gap-8 justify-between">
              <div className="text-[#0B3937 grid gap-3">
                ...
                <div className="">
                  ...
                  <p>Addision Best 8, Awesome Str. Ottawa OT BDG 1DF Canada.</p>
                </div>
                <div className="">
              ...
              <p className="text-green-800">Your order is scheduled for delivery on <span className="font-bold">10th July, 2024</span>. <Link className="text-red-400">Click here</Link> to track order</p>
            </div>
          </div>
          <div className="pt-24 text-center"><Btn name='Continue shopping' to='/' /></div>
        </div>
      </div>
    </div>
  </>)
